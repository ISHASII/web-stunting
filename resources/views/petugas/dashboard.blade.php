        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-2xl p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <div class="flex-1 text-center sm:text-left">
                    ...
                    <div class="mt-4 sm:mt-6 p-3 bg-blue-100/50 rounded-xl border border-blue-200 sm:hidden">
                        <div class="flex items-start space-x-2">
                            <svg class="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                            </svg>
                            <div>
                                <p class="text-blue-800 font-medium text-xs">Tips Mobile</p>
                                <p class="text-blue-700 text-xs mt-1">Ketuk kartu di atas untuk detail lebih lanjut</p>
                            </div>
                        </div>
                    </div>
                </div>
